...
function loadEventsToCommunityOwnPosts() {
    ...
    $.ajax({
        url: ' https://2800hostlocal.azurewebsites.net/ownCommunityPost/read',
        type: 'GET',
...
function deleteEvent() {
    ...
    console.log(postId)
    $.ajax({
        url: ` https://2800hostlocal.azurewebsites.net/ownCommunityPost/delete/${postId}`,
...
function submitCommunityFormBtn() {
    ...
    if (eventTitleVar === "" || eventOrganizerName === "" || eventLocationVar === "" || eventDescriptionVar === "") {
        ...
        $.ajax({
            url: " https://2800hostlocal.azurewebsites.net/newCommunityPostForm/create",
            type: "put",
            data: {
