...
function loadEventsToJobOwnPosts() {
    $('#ownJobPost').empty()
    $.ajax({
        url: ' https://2800hostlocal.azurewebsites.net/ownJobPost/read',
        type: 'GET',
...
function deleteEvent() {
    ...
    console.log(postId)
    $.ajax({
        url: ` https://2800hostlocal.azurewebsites.net/jobPost/delete/${postId}`,
...
function submitJobFormBtn() {
    ...
    $.ajax({
        url: " https://2800hostlocal.azurewebsites.net/newJobPost/create",
        type: "put",
        data: {
            jobTitle: jobTitle,
            city: city,
